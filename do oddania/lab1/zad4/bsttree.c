...
bst_node_t* create_bst_node(contact_t* contact){
...
void add_contact_to_address_book_tree(bst_tree_t* tree, contact_t* contact){
  if(tree) add_bst_node(tree, create_bst_node(contact));
}
