...
int main(){
  ...
  void* handle = dlopen("./libad.so", RTLD_NOW);
  if(handle == NULL){
    printf("Nie udalo sie zaladowac biblioteki\n");
  }
  //double (*cosine)(double) = (double (*)double)dlsym(handle)
  contact_t* (*create_contact)(char*, char*, char*, char*, char*, char*) = (contact_t* (*)(char*, char*, char*, char*, char*, char*)) dlsym(handle, "create_contact");
